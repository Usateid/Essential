<template>
  ...
  >
    <nav class="mt-4">
      <a
        class="flex items-center py-2 px-8 bg-gray-200 text-gray-700 border-r-4 border-gray-700"
        href="#"
      >
        <svg
          class="h-5 w-5"
  ...
  <!-- <div class="flex fixed flex-col sm:flex-row sm:justify-around">
    <div class="w-64 mt-16 bg-white">
...
export default {
  computed: {
    sidebarIsOpen: get('options/sidebarIsOpen'),
  },
}
</script>
...
.left-sidebar {
  ...
  transition: margin 0.5s; /* 0.5 second transition effect to slide in the sidebar */
  @apply -ml-56;
  &.open {
    @apply ml-0;
  }
